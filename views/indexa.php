        ...
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column">
                <span class="font-weight-bold mb-2"><?php echo $_SESSION["pr"] ;?> </span>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#general-pages" aria-expanded="false" aria-controls="general-pages">
              <span class="menu-title">gerer client ou admin</span>
              <i class="menu-arrow"></i>
            ...
            <div class="collapse" id="general-pages">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/samples/supprimerclient.php"> supprimer client </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/samples/search_client2.php"> rechercher client </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/samples/supprimeradmin.php"> desactiver compte </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/samples/modifieradmin.php"> modifier admin </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/samples/modifierclient.php"> modifier client </a></li>
              </ul>
              </div>
          </li>
