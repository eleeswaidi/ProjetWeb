...
{
 $chart_data .= "{ Destination:'".$row["Destination"]."', Idlivraison:".$row["Idlivraison"]."}, ";
}
 ...
 <script src="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.min.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Les destinations les plus fréquentes'
        };
...
<body>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="livreurr.php">Livreur</a></li>
                <li class="nav-item"> <a class="nav-link" href="livraisonn.php"> Livraison</a></li>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Wapi</h2>
   <h3 align="center">Statistiques Des Nombres De Livraisons Par Rapport Aux Regions </h3>   
   <br /><br />
   <div id="chart"></div>
  </div>
...
Morris.Bar({
 ...
 xkey:'Destination',
 ykeys:['Idlivraison', 'Idlivraison'],
 labels:['Destination', 'Idlivraison' ],
 hideHover:'auto',
 stacked:true
});
</script>
